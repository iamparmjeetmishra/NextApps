...
const HomePage = (props: Props) => {
        ...
        <div className="flex flex-row flex-1">
          <div className="border-primary/5 border-2 max-w-xs flex flex-col gap-2 justify-between shadow-md">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant={isRecording ? 'destructive' : 'outline'} size={'icon'} onClick={userPromptVideo}>
                <BiVideo />
                </Button>
              <Separator />
            </div>
            ...
            <div className="flex flex-col gap-2">
              <Button variant={autoRecordEnabled ? 'destructive' :  'outline'} size={'icon'} onClick={toggleAutoRecord}>
                {autoRecordEnabled ? <Rings color="white" height={45} /> : <BsPersonStanding />}
              </Button>
          ...
          <div className="h-full flex-1 py-4 px-2 overflow-x-scroll">
  ...
  function userPromptVideo() {
    ...
    if(mediaRecorderRef.current?.state == 'recording') {
      ...
      toast({
        description: 'Recording saved to download'
      })
    } else {
  ...
  function toggleAutoRecord() {
    if (autoRecordEnabled) {
      ...
      // Toast
      toast({
        description: 'Auto record is disabled'
      })
      ...
      // toast
      toast({
        description: 'Auto record is enabled'
      })
    }
    ...
    return <div className="text-xs text-muted-foreground">
      <ul className="space-y-4">
        ...
        <li>
          ...
          ><LuFlipHorizontal size={14} /></Button>
        </li>
        <Separator />
        <li>
        ...
        <li>
          ...
          >
            {autoRecordEnabled ? <Rings color='white' height={30} /> : <BsPersonStanding size={14} />}
