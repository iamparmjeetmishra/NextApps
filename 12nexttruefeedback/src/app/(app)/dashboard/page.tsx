...
export default function Dashboard() {
	...
	// Newer Version has different callback
	...
	const handleSwitchChange = async () => {
		try {
      const response = await axios.post<ApiResponse>("/api/get-message", {
  ...
  return (
    <main className="my-8 mx-4 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl">
